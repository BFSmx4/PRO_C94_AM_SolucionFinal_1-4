                ...
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    <View style={styles.gifContainer}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>Díametro mínimo (KM) - {item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
                            <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>Díametro Máximo (KM) - {item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
                            ...
                            <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>Alejándose de la Tierra por (KM) - {item.close_approach_data[0].miss_distance.kilometers}</Text>
                        </View>
                    </View>
                </ImageBackground>
            </View>
